							...
							<form id="formLogin">
								...
								<div class="card-login mt-index">
									<div class="card-login-body">
										...
										<div class="row mb-2">
											<div class="col-lg-4 offset-lg-4 col-md-4 offset-lg-4 col-sm-4 offset-sm-4 col-4 offset-4 mt-4">
												<img src="webapp/assets/images/logo.png" class="img img-fluid"/>
											</div>
										</div>
										...
										<div class="row" align="left">
											...
											<div class="col-12 mt-4 mb-4">
												<div class="d-grid gap-2" align="center">
													<button type="button" class="btn btn-lg btn-dark bg-primary-dark-lib border-primary-dark-lib btn-redondo" id="btnLogin" onclick="fn_login();">
														Iniciar sesión
													</button>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-12 mt-4 text-secondary fs-8" align="right">
												© LIB laboratorios <br>Todos los derechos reservados
											</div>
										</div>
